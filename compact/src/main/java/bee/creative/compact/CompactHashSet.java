 ...
 * benötigen würde. Bei einer Anzahl von ca. {@code 100} Elementen benötigen Beide {@link Set}s dafür in etwa die
 * gleichen Rechenzeiten. Bei weniger Elementen ist das {@link CompactHashSet} schneller, bei mehr Elementen ist das
 * {@link HashSet} schneller. * Bei der erhöhung der Anzahl der Elemente auf das {@code 32}-fache ( {@code 5}
 * Verdopplungen) steigt die Rechenzeit beim Hinzufügen und Entfernen von Elementen in einem {@link CompactHashSet} auf
 * {@code 8827%} der Rechenzeit, die ein {@link HashSet} hierfür benötigen würde.
 * <p>
 * Für das Finden von Elementen und das Iterieren über die Elemente benötigt das {@link CompactHashSet} im Mittel nur
 * noch {@code 75%} der Rechenzeit des {@link HashSet}s, unabhängig von der Anzahl der Elemente.
 * 
 * @see Object#hashCode()
