...
public interface QTSet extends QOSet<QT, QTSet> {
	...
	public QESet edges(int context, int predicate, int subject, int object) throws NullPointerException, IllegalArgumentException;
	 ...
	 * @return Hypertupel dieser Menge als Hyperkanten. */
	public QESet edges(String context, String predicate, String subject, String object) throws NullPointerException, IllegalArgumentException;
