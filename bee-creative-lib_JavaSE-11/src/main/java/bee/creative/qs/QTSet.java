...
public interface QTSet extends QOSet<QT, QTSet> {
	...
	int[] roles(String... names) throws NullPointerException;
	...
	/** Diese Methode gibt eine Mengensicht auf die Hypertupel dieser Menge als Hyperkanten zurück.
	 *
	 ...
	 * @return Hypertupel dieser Menge als Hyperkanten. */
	QESet edges(String context, String predicate, String subject, String object) throws NullPointerException, IllegalArgumentException;
	 ...
	 *
	 * @see #role(String) */
	QNSet nodes(String name) throws NullPointerException, IllegalArgumentException;
	 ...
	 *
	 * @see #roles(String...) */
	QTSet select(String... names) throws NullPointerException, IllegalArgumentException;

	/** Diese Methode ist eine Abkürzung für {@link #select(int...) this.select(this.roles(names))}.
	 *
	 * @see #roles(List) */
	QTSet select(List<String> names) throws NullPointerException, IllegalArgumentException;
	 ...
	 *
	 * @see #role(String) */
	QTSet withNode(String name, QN node) throws NullPointerException, IllegalArgumentException;
	 ...
	 *
	 * @see #role(String) */
	QTSet withNodes(String name, QNSet nodes) throws NullPointerException, IllegalArgumentException;

	/** Diese Methode ist eine Abkürzung für {@link #withNames(List) this.withNames(Arrays.asList(names))}.
	 *
	 * @see Arrays#asList(Object...) */
	QTSet withNames(String... names) throws NullPointerException, IllegalArgumentException;
	 ...
	 *
	 * @see #role(String) */
	QTSet havingNode(String name, QN node) throws NullPointerException, IllegalArgumentException;
	 ...
	 *
	 * @see #role(String) */
	QTSet havingNodes(String name, QNSet nodes) throws NullPointerException, IllegalArgumentException;
