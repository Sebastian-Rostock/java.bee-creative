...
public class HashMapII extends AbstractHashMap<Integer, Integer> implements Serializable, Cloneable {
	...
	public HashMapII(Map<? extends Integer, ? extends Integer> source) {
		this(source.size());
		this.putAll(source);
	}
	...
	public HashMapII clone() {
		var result = (HashMapII)super.clone();
	...
	private void writeObject(ObjectOutputStream stream) throws IOException {
		...
		for (Entry<Integer, Integer> entry: this.newEntriesImpl()) {
