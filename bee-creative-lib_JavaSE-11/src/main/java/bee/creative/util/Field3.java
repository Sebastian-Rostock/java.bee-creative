...
public interface Field3<GItem, GValue> extends Field<GItem, GValue> {

	/** Diese Methode ist eine Abkürzung für {@link Fields#setupField(Field, Getter) setupField(this, setup)}. */
	default Field3<GItem, GValue> setup(Getter<? super GItem, ? extends GValue> setup) {
	...
	default <GValue2> Field3<GItem, GValue2> translate(Getter<? super GValue, ? extends GValue2> getTrans, Getter<? super GValue2, ? extends GValue> setTrans) {
	...
	default <GValue2> Field3<GItem, GValue2> translate(Translator<GValue, GValue2> trans) {
	 ...
	 * mixed)}. */
	default <GItem2 extends Iterable<? extends GItem>, GValue2> Field3<GItem2, GValue2> aggregate(Getter<? super GValue, ? extends GValue2> getTrans,
	...
	default Field3<GItem, GValue> optionalize() {
	...
	default Field3<GItem, GValue> synchronize(Object mutex) {
