...
/**
 * Diese Klasse implementiert einen abstrakten Abschnitt eines Arrays. Definiert wird ein Abschnitt für ein Array
 * {@link #array()} der Länge {@link #arrayLength()} mit dem Index des ersten Werts im Abschnitt ({@link #startIndex()})
 * sowie dem Index des ersten Werts nach dem Abschnitt ({@link #finalIndex()}).
 * <p>
 * Die Methoden {@link #hashCode()}, {@link #equals(Object)} und {@link #toString()} reflektieren die Werte im
 * Abschnitt.
 * 
...
public abstract class ArraySection<GArray> implements Comparable<ArraySection<GArray>> {
	...
	/**
	 * Diese Methode gibt den {@link Object#hashCode() Streuwert} des {@code index}-ten Werts des gegebenen Arrays zurück
	 * und wird in {@link ArraySection#hashCode()} verwendet.
	 * 
	 * @param array Array.
	 * @param index Index.
	...
	/**
	 * Diese Methode gibt die {@link Object#equals(Object) Äquivalenz} der {@code index}-ten Werte der gegebenen Arrays
	 * zurück und wird in {@link ArraySection#equals(Object)} verwendet.
	 * 
	...
	/**
	 * Diese Methode gibt den {@link Comparator#compare(Object, Object) Vergleichswert} der {@code index}-ten Werte der
	 * gegebenen Arrays zurück und wird in {@link ArraySection#compareTo(ArraySection)} verwendet.
	 * 
	 * @param array1 Array 1.
	 * @param array2 Array 2.
	 * @param index1 Index für Array 1.
	...
	/**
	 * Diese Methode fügt den {@code index}-ten Wert des gegebenen Arrays an den gegebenen {@link StringBuilder} an und
	 * wird in {@link ArraySection#toString()} verwendet.
	 * 
