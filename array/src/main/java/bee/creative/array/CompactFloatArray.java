...
public class CompactFloatArray extends CompactArray<float[], Float> implements FloatArray {
	...
	/**
	 * Diese Klasse implementiert ein {@link FloatArray} als modifizierbare Sicht auf einen Teil eines
	 * {@link CompactFloatArray}s.
	 * 
	 * @author [cc-by] 2012 Sebastian Rostock [http://creativecommons.org/licenses/by/3.0/de/]
	 */
	protected static class CompactFloatSubArray extends CompactSubArray<CompactFloatArray, float[], Float> implements
		FloatArray {
	 ...
	 */
	public CompactFloatArray(final ArraySection<float[]> section) throws NullPointerException, IndexOutOfBoundsException,
