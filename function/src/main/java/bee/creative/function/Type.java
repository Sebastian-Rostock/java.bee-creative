...
/**
 * Diese Schnittstelle definiert den Datentyp eines {@link Value}{@code s}, analog zur {@link Class} eines {@link Object}{@code s}. Ein {@link Type} besitzt
 * Methoden zum Lesen und Konvertieren des {@link Value#data() Datensatzes} eines {@link Value}{@code s} sowie zur Prüfung der Kompatibilität zu anderen
 * Datentypen.
 * 
