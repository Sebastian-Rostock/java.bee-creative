 ...
 * @author [cc-by] 2013 Sebastian Rostock [http://creativecommons.org/licenses/by/3.0/de/] */
	...
	public static final class Token implements Array2<Token>, Comparable<Token> {
		...
		public static final Token EMPTY = new Token(Source.EMPTY, 0, 0, new Token[0]);
		...
		public static Token from(final Source source, final int offset, final int length, final Token... tokens)
		 ...
		 * @throws IllegalArgumentException Wenn der Abschnitt außerhalb der Eingabe liegt oder seine Länge negativ ist. */
		public static Token from(final Source source, final int offset, final int length, final int type) throws NullPointerException, IllegalArgumentException {
		 ...
		 * @throws NullPointerException Wenn {@code source} bzw. {@code tokens} {@code null} ist oder enthält.
		 * @throws IllegalArgumentException Wenn der Abschnitt außerhalb der Eingabe liegt oder seine Länge negativ ist. */
		public static Token from(final Source source, final int offset, final int length, final int type, final Token... tokens)
			throws NullPointerException, IllegalArgumentException {
		 ...
		 * @throws NullPointerException Wenn {@code source} bzw. {@code tokens} {@code null} ist oder enthält.
		 * @throws IllegalArgumentException Wenn der Abschnitt außerhalb der Eingabe liegt oder seine Länge negativ ist. */
		public static Token from(final Source source, final int offset, final int length, final int type, final Iterable<Token> tokens)
			throws NullPointerException, IllegalArgumentException {
		...
		private Token(final Source source, final int offset, final int length, final Token[] tokens) throws NullPointerException, IllegalArgumentException {
		...
		/** Diese Methode liefert die Zeichenkette des Abschnittsinhalts.
		 *
		 * @see #toSource() */
		@Override
		...
		/** Diese Methode liefert den Abschnittsinhalt.
		 *
		 * @see #end()
		 * @see #start()
		 * @see #source()
		 * @see Source#section(int, int) */
	...
	public static class Source {
		...
		public static Source EMPTY = new Source(new char[0], 0, 0);
		...
		public static Source from(final String chars) throws NullPointerException {
			return new Source(chars.toCharArray());
		}

		public Source(final char[] chars) throws NullPointerException {
			this(chars, 0, chars.length);
		}

		public Source(final char[] chars, final int offset, final int length) throws NullPointerException, IllegalArgumentException {
		...
		public Source section(final int offset, final int length) {
		...
		public CharacterArraySection toSection() {
			return CharacterArraySection.from(this.chars, this.offset, this.offset + this.length);
		}
	...
	public __Parser(final String source) throws NullPointerException {
	...
	public final void setSource(final Source source) throws NullPointerException {
	 ...
	 * {@link Token#from(Source, int, int, int) Token.from(this.getSource(), offset, length, type)}.
	 *
	 * @param type Abschnittstyp
	 * @param offset Abschnittsbeginn.
	 * @param length Abschnittslänge.
	...
	public final Token make(final int type, final int offset, final int length) throws IllegalArgumentException {
		return Token.from(this.getSource(), offset, length, type);
	}
	...
	/** Diese Methode erzeugt einen neuen Abschnitt mit den gegebenen Eigenschaften. Sie ist eine Abkürzung für {@link Token#from(Source, int, int, int, Iterable)
	 * Token.from(this.getSource(), offset, length, type, tokens)}.
	 *
	 * @param type Abschnittstyp
	 * @param offset Abschnittsbeginn.
	 * @param length Abschnittslänge.
	...
	public final Token make(final int type, final int offset, final int length, final Iterable<Token> tokens)
		throws NullPointerException, IllegalArgumentException {
		return Token.from(this.getSource(), offset, length, type, tokens);
	}
