...
final class MMIArrayS1R extends MMIArrayS {

	MMIArrayS1R(final ByteBuffer buffer, final int length, final int address) {
	...
	protected MMIArray customSection(final int offset, final int length) {
		return new MMIArrayS1R(this.buffer, length, this.address + (offset * 2));
	}
