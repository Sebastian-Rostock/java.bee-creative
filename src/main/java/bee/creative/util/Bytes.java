...
public final class Bytes {
	...
	public static int getInt2BE(final byte[] array, final int index) {
		return ((array[index + 0] & 0xFF) << 8) | (array[index + 1] & 0xFF);
	}
	...
	public static int getInt2LE(final byte[] array, final int index) {
		return ((array[index + 1] & 0xFF) << 8) | (array[index + 0] & 0xFF);
	}
	...
	public static int getInt3BE(final byte[] array, final int index) {
		return ((array[index + 0] & 0xFF) << 16) | ((array[index + 1] & 0xFF) << 8) | (array[index + 2] & 0xFF);
	}
	...
	public static int getInt3LE(final byte[] array, final int index) {
		return ((array[index + 2] & 0xFF) << 16) | ((array[index + 1] & 0xFF) << 8) | (array[index + 0] & 0xFF);
	}
	...
	public static int getInt4BE(final byte[] array, final int index) {
		return ((array[index + 0] & 0xFF) << 24) | ((array[index + 1] & 0xFF) << 16) | ((array[index + 2] & 0xFF) << 8) | (array[index + 3] & 0xFF);
	}
	...
	public static int getInt4LE(final byte[] array, final int index) {
		return ((array[index + 3] & 0xFF) << 24) | ((array[index + 2] & 0xFF) << 16) | ((array[index + 1] & 0xFF) << 8) | (array[index + 0] & 0xFF);
	}
	...
	public static long getLongBE(final byte[] array, final int index, final int size) {
		switch (size) {
			...
			case 8:
				return Bytes.getLongBE(array, index);
			default:
				throw new IllegalArgumentException();
		}
	}
	...
	public static long getLong5BE(final byte[] array, final int index) {
		return ((long)Bytes.getInt1(array, index) << 32) | Bytes.getInt4BE(array, index + 1);
	}
	...
	public static long getLong6BE(final byte[] array, final int index) {
		return ((long)Bytes.getInt2BE(array, index) << 32) | Bytes.getInt4BE(array, index + 2);
	}
	...
	public static long getLong7BE(final byte[] array, final int index) {
		return ((long)Bytes.getInt3BE(array, index) << 32) | Bytes.getInt4BE(array, index + 3);
	}
	...
	public static long getLongBE(final byte[] array, final int index) {
		return ((long)Bytes.getInt4BE(array, index) << 32) | Bytes.getInt4BE(array, index + 4);
	}
