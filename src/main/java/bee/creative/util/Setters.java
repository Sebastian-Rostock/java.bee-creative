...
import bee.creative.util.Fields.EmptyField;
...
public class Setters {
	...
	public static class ConcatSetter<GItem, GItem2, GValue> extends AbstractSetter<GItem, GValue> {
		...
		public ConcatSetter(final Getter<? super GItem, ? extends GItem2> source, final Setter<? super GItem2, ? super GValue> target) throws NullPointerException {
	...
	public static class TranslatedSetter<GItem, GSource, GTarget> extends AbstractSetter<GItem, GTarget> {
		...
		public final Setter<? super GItem, ? super GSource> target;

		public final Getter<? super GTarget, ? extends GSource> trans;

		public TranslatedSetter(final Setter<? super GItem, ? super GSource> target, final Getter<? super GTarget, ? extends GSource> trans) {
			this.target = Objects.notNull(target);
	...
	public static class AggregatedSetter<GItem, GSource, GTarget> extends AbstractSetter<Iterable<? extends GItem>, GTarget> {
		...
		public final Setter<? super GItem, GSource> target;

		public final Getter<? super GTarget, ? extends GSource> trans;

		public AggregatedSetter(final Setter<? super GItem, GSource> target, final Getter<? super GTarget, ? extends GSource> trans) throws NullPointerException {
			this.target = Objects.notNull(target);
			this.trans = Objects.notNull(trans);
		}
		...
		public void set(final Iterable<? extends GItem> item, final GTarget value) {
			...
			final GSource value2 = this.trans.get(value);
			do {
	...
	public static <GItem, GSource, GTarget> Setter3<GItem, GTarget> toTranslated(final Setter<? super GItem, ? super GSource> target,
		...
		return new TranslatedSetter<>(target, trans);
	}
