...
final class MMIArrayS0R extends MMIArrayS {

	MMIArrayS0R(final ByteBuffer buffer, final int length, final int address) {
	...
	protected MMIArray customSection(final int offset, final int length) {
		return new MMIArrayS0R(this.buffer, length, this.address + offset);
	}
