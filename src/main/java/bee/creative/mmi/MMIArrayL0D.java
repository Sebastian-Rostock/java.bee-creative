...
final class MMIArrayL0D extends MMIArrayL {

	MMIArrayL0D(final MappedBuffer buffer, final int length, final long address) throws IllegalArgumentException {
	...
	protected MMIArray customSection(final int offset, final int length) {
		return new MMIArrayL0D(this.buffer, length, this.address + offset);
	}
