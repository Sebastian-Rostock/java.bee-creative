...
public final class FEMCompiler extends Parser {
	...
	// * @return {@code this}.
	// * @throws IllegalStateException Wenn bereits eine Verarbeitung läuft. */
	// public final FEMCompiler useArrayEnabled(final boolean value) throws IllegalStateException {
	// this.check();
	...
	// * @return {@code this}.
	// * @throws IllegalStateException Wenn bereits eine Verarbeitung läuft. */
	// public final FEMCompiler useChainingEnabled(final boolean value) throws IllegalStateException {
	// this.check();
	...
	// * @return {@code this}.
	// * @throws IllegalStateException Wenn bereits eine Verarbeitung läuft. */
	// public final FEMCompiler useClosureEnabled(final boolean value) throws IllegalStateException {
	// this.check();
