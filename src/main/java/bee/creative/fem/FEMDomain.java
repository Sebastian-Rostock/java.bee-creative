...
public class FEMDomain {
	 ...
	 * Konstante Parameterwerte können als {@link FEMValue} oder {@link FEMProxy} geliefert werden. Funktion als Parameterwert können als {@link FEMHandler} oder
	 * {@link FEMClosure} geliefert werden.
	 * 
