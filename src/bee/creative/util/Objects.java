...
public final class Objects {
	 ...
	 */
	static public final boolean equalsAll(final Objects... objects) {
	 ...
	 * aktiviert werden. Der Rückgabewert entspricht:
	 * 
	 * <pre>
	 ...
	 * sowie die Erhöhung des Einzugs aktiviert werden.
	 * 
	 * @param object Objekt oder <code>null</code>.
	 * @param format Aktivierung der hierarchische Formatierung.
	...
	/**
	 * Diese Methode gibt das gegebene {@link Iterable Iterable} als {@link Object#toString() Textdarstelung} zurück. Der
	 * Rückgabewert entspricht:
	 * 
	 * <pre>
